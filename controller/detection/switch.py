...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def switch_features_handler(self, ev):
        ...
        # * logging switch id
        self.logger.info("Switch initialized: " + str(datapath.id))
    ...
    def _packet_in_handler(self, ev):
        ...
        formatted_dpid = format(datapath.id, "d").zfill(16)
        self.logger.info("packet in %s %s %s %s %s", formatted_dpid, src, dst, in_port, timestamp)
        
        log = {}
        log['switchid'] = datapath.id
